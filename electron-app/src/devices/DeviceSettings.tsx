...
export function DeviceSettings() {
  ...
  return (
    <div className={classes.root}>
      ...
      <TextField label="Number of LEDs" placeholder="1-490" className={classes.formField} type="number"/>
      ...
      <Slider aria-labelledby="saturation-slider" className={classes.formField} valueLabelDisplay="auto" min={-100} max={100}/>
      <Typography gutterBottom className={classes.formField}>
        Blur Radius
      </Typography>
